...
namespace Qim
{
    ...
    public enum SequentialGuidType
    {
        ...
        /// Use For: MySql,PostgreSql(varchar类型)
        /// </summary>
        SequentialAsString,
        ...
        /// of the Data4 block.
        /// Use For: SqlServer(uniqueidentifier类型)
        /// </summary>
        SequentialAtEnd
    }
    ...
    public class SequentialGuidGenerator : IGuidGenerator
    {
        ...
        /// </summary>
        public static readonly SequentialGuidGenerator Instance = new SequentialGuidGenerator();
