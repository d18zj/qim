...
[module:
    System.Diagnostics.CodeAnalysis.SuppressMessage("StyleCop.CSharp.ReadabilityRules",
        "SA1101:PrefixLocalCallsWithThis", Justification = "No inheritance")]
[module:
    System.Diagnostics.CodeAnalysis.SuppressMessage("StyleCop.CSharp.MaintainabilityRules",
        "SA1402:FileMayOnlyContainASingleClass", Justification = "Single source file deployment.")]
[module:
    System.Diagnostics.CodeAnalysis.SuppressMessage("StyleCop.CSharp.MaintainabilityRules",
        "SA1403:FileMayOnlyContainASingleNamespace", Justification = "Extension methods must be visible")]
[module:
    System.Diagnostics.CodeAnalysis.SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1633:FileMustHaveHeader",
        Justification = "Custom header.")]
[module:
    System.Diagnostics.CodeAnalysis.SuppressMessage("StyleCop.CSharp.DocumentationRules",
        "SA1600:ElementsMustBeDocumented", Justification = "All public members are documented.")]
...
namespace LightInject
{
    ...
    public static class InterceptionContainerExtensions
    {
        ...
        ///     A function delegate that is used to determine if the proxy-based decorator should be
        ///     applied to the target service.
        /// </param>
        ...
        public static void Intercept(this IServiceRegistry serviceRegistry,
            Func<ServiceRegistration, bool> serviceSelector, Type[] additionalInterfaces,
            Action<IServiceFactory, ProxyDefinition> defineProxyType)
        {
            var decoratorRegistration = new DecoratorRegistration();
            decoratorRegistration.CanDecorate =
                registration =>
                    serviceSelector(registration) && registration.ServiceType != typeof(IInterceptor) &&
                    registration.ServiceType.GetTypeInfo().IsInterface;
            decoratorRegistration.ImplementingTypeFactory =
                (serviceFactory, serviceRegistration) =>
                    CreateProxyType(serviceRegistration.ServiceType, additionalInterfaces, serviceFactory,
                        defineProxyType, serviceRegistration);
            serviceRegistry.Decorate(decoratorRegistration);

            // class based proxies
            serviceRegistry.Override(serviceSelector,
                (serviceFactory, registration) =>
                    CreateProxyServiceRegistration(registration, additionalInterfaces, serviceFactory,
                        defineProxyType));
        }
        ...
        /// <param name="defineProxyType">An action delegate that is used to define the proxy type.</param>
        public static void Intercept(this IServiceRegistry serviceRegistry,
            Func<ServiceRegistration, bool> serviceSelector, Action<IServiceFactory, ProxyDefinition> defineProxyType)
        {
        ...
        public static void Intercept(this IServiceRegistry serviceRegistry,
            Func<ServiceRegistration, bool> serviceSelector, Func<IServiceFactory, IInterceptor> getInterceptor)
        {
            Intercept(serviceRegistry, serviceSelector, new Type[0],
                (factory, definition) => definition.Implement(() => getInterceptor(factory)));
        }

        /// <summary>
        ///     Intercepts methods that matches the <paramref name="methodSelector" /> and uses the
        ///     <paramref name="implementation" /> delegate
        ...
        private static Func<ServiceRegistration, bool> HasMethodsThatMatchesMethodSelector(
            Func<MethodInfo, bool> methodSelector)
        {
        ...
        private static Type CreateProxyType(
            Type serviceType, Type[] additionalInterfaces, IServiceFactory serviceFactory,
            Action<IServiceFactory, ProxyDefinition> defineProxyType, ServiceRegistration registration)
        {
            bool hasLazyTarget = true;

            if (registration.FactoryExpression != null &&
                GetMethod(registration.FactoryExpression).GetParameters().Length > 1)
            {
                hasLazyTarget = false;
            }
        ...
        private static ServiceRegistration CreateProxyServiceRegistration(ServiceRegistration registration,
            Type[] additionalInterfaces, IServiceFactory serviceFactory,
            Action<IServiceFactory, ProxyDefinition> defineProxyType)
        {
            ...
            var proxyType = CreateProxyType(registration.ImplementingType, additionalInterfaces, serviceFactory,
                defineProxyType, registration);
...
namespace LightInject.Interception
{
    ...
    public interface IProxyBuilder
    {
        ...
        ///     A <see cref="ProxyDefinition" /> instance that contains information about the
        ///     proxy type to be created.
        /// </param>
    ...
    public interface IInterceptor
    {
        ...
        ///     The <see cref="IInvocationInfo" /> instance that
        ///     contains information about the current method call.
        /// </param>
    ...
    {
        private static readonly IMethodBuilder ProceedDelegateBuilder =
            new CachedMethodBuilder(new DynamicMethodBuilder());

        /// <summary>
        ///     The <see cref="MethodInfo" /> that represents the target method.
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("StyleCop.CSharp.MaintainabilityRules",
             "SA1401:FieldsMustBePrivate", Justification = "Loading a field is faster than going through a property.")] public MethodInfo Method;

        /// <summary>
        ///     The function delegate used to invoke the target method.
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("StyleCop.CSharp.MaintainabilityRules",
             "SA1401:FieldsMustBePrivate", Justification = "Loading a field is faster than going through a property.")] public Lazy<Func<object, object[], object>> ProceedDelegate;
    ...
    public class DynamicMethodBuilder : IMethodBuilder
    {
        ...
        {
            il.Emit(
                method.IsAbstract || method.GetDeclaringType() == typeof(AsyncInterceptor)
                    ? OpCodes.Callvirt
                    : OpCodes.Call, method);
        }
        ...
        {
            private readonly DynamicMethod dynamicMethod = new DynamicMethod("DynamicMethod", typeof(object),
                new[] {typeof(object), typeof(object[])}, typeof(DynamicMethodSkeleton).GetTypeInfo().Module, true);
    ...
    public class TargetInvocationInfo : IInvocationInfo
    {
        ...
        /// </summary>
        /// <param name="targetMethodInfo">
        ///     The <see cref="TargetMethodInfo" /> that contains
        ///     information about the target method.
        /// </param>
        ...
        {
            get { return targetMethodInfo.Method; }
        }
    ...
    public class InterceptorInvocationInfo : IInvocationInfo
    {
        ...
        /// </summary>
        /// <param name="nextInvocationInfo">
        ///     The next <see cref="IInvocationInfo" /> used to invoke the
        ///     <paramref name="nextInterceptor" />.
        /// </param>
        ...
        public MethodInfo Method
        {
            get { return nextInvocationInfo.Method; }
        }
        ...
        public IProxy Proxy
        {
            get { return nextInvocationInfo.Proxy; }
        }
        ...
        public object[] Arguments
        {
            get { return nextInvocationInfo.Arguments; }
        }
    ...
    public class ProxyDefinition
    {
        ...
        /// </summary>
        /// <param name="targetType">The type of object to proxy.</param>
        /// <param name="useLazyTarget">
        ///     Indicates whether the proxy type
        ...
        {
            get { return typeAttributes.SelectMany(t => t); }
        }
        ...
        ///     The <see cref="CustomAttributeData" /> instance that
        ///     represents the custom attribute to be added to the proxy type.
        /// </param>
        /// <returns>This instance.</returns>
    ...
    public static class InterceptionMethodInfoExtensions
    {
        ...
        /// <summary>
        ///     Gets a value that indicates whether the <paramref name="method" /> is declared by the given
        ///     <paramref name="type" />.
        /// </summary>
        ...
        public static PropertyInfo GetProperty(this MethodInfo method)
        {
            return
                method.GetDeclaringType()
                    .GetTypeInfo()
                    .DeclaredProperties.FirstOrDefault(p => p.GetMethod == method || p.SetMethod == method);
        }
    }
    ...
    public class ProxyBuilder : IProxyBuilder
    {
        ...
        static ProxyBuilder()
        {
            ...
            TargetMethodInfoConstructor =
                typeof(TargetMethodInfo).GetTypeInfo().DeclaredConstructors.Single(m => !m.IsStatic);
            OpenGenericTargetMethodInfoConstructor =
                typeof(OpenGenericTargetMethodInfo).GetTypeInfo().DeclaredConstructors.Single(m => !m.IsStatic);
            LazyInterceptorGetValueMethod = typeof(Lazy<IInterceptor>).GetTypeInfo().DeclaredProperties
                .Single(p => p.Name == "Value").GetMethod;

            TargetInvocationInfoConstructor =
                typeof(TargetInvocationInfo).GetTypeInfo().DeclaredConstructors.Single(m => !m.IsStatic);
        ...
        private static CustomAttributeBuilder CreateCustomAttributeBuilder(CustomAttributeData customAttributeData)
        {
            ...
            var constructor =
                customAttributeData.AttributeType.GetTypeInfo()
                    .DeclaredConstructors.Where(
                        c => c.GetParameters().Select(p => p.ParameterType).SequenceEqual(constructorArguments))
                    .Where(c => !c.IsStatic)
                    .Single();
        ...
        private static void PushInvocationInfoForNonGenericMethod(FieldInfo staticTargetMethodInfoField, ILGenerator il,
            ParameterInfo[] parameters, LocalBuilder argumentsArrayVariable)
        {
        ...
        private static void PushInvocationInfoForGenericMethod(FieldInfo staticOpenGenericTargetMethodInfoField,
            ILGenerator il, ParameterInfo[] parameters, LocalBuilder argumentsArrayVariable,
        ...
        private static void DefineGenericParameters(MethodInfo targetMethod, MethodBuilder methodBuilder)
        {
            ...
            GenericTypeParameterBuilder[] genericTypeParameters =
                methodBuilder.DefineGenericParameters(genericArguments.Select(a => a.Name).ToArray());
            for (int i = 0; i < genericArguments.Length; i++)
            {
                genericTypeParameters[i].SetGenericParameterAttributes(
                    genericArguments[i].GetTypeInfo().GenericParameterAttributes);
                ApplyGenericConstraints(genericArguments[i], genericTypeParameters[i]);
            }
        }

        private static void ApplyGenericConstraints(Type genericArgument,
            GenericTypeParameterBuilder genericTypeParameter)
        {
            var genericConstraints = genericArgument.GetTypeInfo().GetGenericParameterConstraints();
            genericTypeParameter.SetInterfaceConstraints(
                genericConstraints.Where(gc => gc.GetTypeInfo().IsInterface).ToArray());
        ...
        private static void PushArguments(ILGenerator il, ParameterInfo[] parameters,
            LocalBuilder argumentsArrayVariable)
        {
        ...
        private static void UpdateRefArguments(ParameterInfo[] parameters, ILGenerator il,
            LocalBuilder argumentsArrayField)
        {
            for (int i = 0; i < parameters.Length; ++i)
            {
                if (parameters[i].IsOut || parameters[i].ParameterType.IsByRef)
                {
                    ...
                    il.Emit(OpCodes.Ldc_I4, i);
                    il.Emit(OpCodes.Ldelem_Ref);
                    il.Emit(parameterType.GetTypeInfo().IsValueType ? OpCodes.Unbox_Any : OpCodes.Castclass,
                        parameterType);
        ...
        private static void PushTargetMethodInfoForGenericMethod(FieldInfo staticOpenGenericTargetMethodInfoField,
            ILGenerator il, GenericTypeParameterBuilder[] genericParameters)
        {
        ...
        private static void PushTargetMethodInfoForNonGenericMethod(FieldInfo staticTargetMethodInfoField,
            ILGenerator il)
        {
        ...
        {
            var constructors =
                proxyDefinition.TargetType.GetTypeInfo().DeclaredConstructors.Where(c => !c.IsStatic).ToArray();
            ...
            foreach (var constructorInfo in constructors)
            {
                ...
                var constructorBuilder = typeBuilder.DefineConstructor(methodAttributes, callingConvention,
                    parameterTypes);
        ...
        private MethodBuilder ImplementInterceptedMethod(MethodInfo targetMethod, int[] interceptorIndicies)
        {
            ...
            if (targetMethod.IsGenericMethod)
            {
                ...
                PushInvocationInfoForGenericMethod(staticOpenGenericTargetMethodInfoField, il, parameters,
                    argumentsArrayVariable, genericParameters);
            }
            else
            {
                FieldInfo staticTargetMethodInfoField = DefineStaticTargetMethodInfoField(targetMethod);
                PushInvocationInfoForNonGenericMethod(staticTargetMethodInfoField, il, parameters,
        ...
        {
            typeBuilder = typeBuilderFactory.CreateTypeBuilder(proxyDefinition.TargetType,
                proxyDefinition.AdditionalInterfaces);
        ...
        private void DefineStaticTargetFactoryField()
        {
            ...
            targetFactoryField = typeBuilder.DefineField("TargetFactory", funcType,
        ...
        private void DefineInitializerMethodForInterfaceProxy(Type parameterType)
        {
            initializerMethodBuilder = typeBuilder.DefineMethod(
                "InitializeProxy", MethodAttributes.Private | MethodAttributes.HideBySig, typeof(void),
                new[] {parameterType});
        ...
        private void ImplementParameterlessConstructor()
        {
            var constructorBuilder =
                typeBuilder.DefineConstructor(
                    ...
                    MethodAttributes.RTSpecialName, CallingConventions.Standard, new Type[0]);
        ...
        private void ImplementConstructorWithTargetParameter()
        {
            ...
            var constructorBuilder = typeBuilder.DefineConstructor(attributes, CallingConventions.Standard,
                new[] {proxyDefinition.TargetType});
        ...
        private void ImplementLazyInterceptorInitialization(FieldInfo interceptorField,
            FieldInfo interceptorFactoryField)
        {
            var il = initializerMethodBuilder.GetILGenerator();
            il.Emit(OpCodes.Ldarg_0);
    ...
    public class LambdaInterceptor : IInterceptor
    {
        ...
        ///     The function delegate to be used
        ///     as the implementation of the intercepted methods.
        /// </param>
